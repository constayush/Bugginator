  ...
  <div className="flex-1 p-3 md:p-6 h-full  relative overflow-y-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Tasks Card */}
            <div className="w-full bg-[var(--dash-card-bg-color)] hover:bg-purple-500/10 transition cursor-pointer p-4 rounded-lg flex items-center gap-4 shadow-inner border border-gray-300 dark:border-gray-700">
